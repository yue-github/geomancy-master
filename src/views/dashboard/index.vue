<template>
  <div class="dashboard-container">
    <div class="dashboard-text">小程序历史访问量/次:<span style="color:rgb(64, 158, 255)">{{ count }}</span></div>
...
export default {
  ...
  mounted(){
    this.$axios.post(domain+'api/visit/getVisit')
    .then(res=>{
     
      this.count=Math.ceil(parseFloat(res.data[0].count)/2);
      return this.count;
    })
.then(res=>{
